...
check(is_writable(__DIR__.'/../planning/cache'), sprintf('Checking that cache/ directory is writable'), 'Change the permissions of the hello/cache/ directory so that the web server can write in it', true);
check(is_writable(__DIR__.'/../planning/logs'), sprintf('Checking that the logs/ directory is writable'), 'Change the permissions of the hello/logs/ directory so that the web server can write in it', true);
